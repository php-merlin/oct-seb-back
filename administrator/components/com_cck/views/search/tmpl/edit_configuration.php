...
<div class="<?php echo $this->css['wrapper']; ?>">
    ...
    <div class="seblod">
        ...
        <ul class="adminformlist adminformlist-2cols">
            ...
            echo JCckDev::renderForm( 'core_dev_select', $this->item->sef_route_aliases, $config, array( 'label'=>'SEF Multi Aliases', 'selectlabel'=>'', 'defaultvalue'=>'', 'options'=>'Use Global SL=-1||No=0||Yes=optgroup||All languages=2||All languages but default=1', 'storage_field'=>'sef_route_aliases' ) );
            ?>
        </ul>
    </div>
	<div class="seblod">
