...
class pkg_cckInstallerScript
{
	...
	public function postflight( $type, $parent )
	{
		...
		if ( $type == 'install' ) { /* TODO#SEBLOD4: we cannot really trust the above. After a failed update, package won't be there and so it will behave as an install which is NOT great.. :( */
			// Set Permissions
			$rule	=	'{"core.delete.own":{"6":1},"core.addto.cart":{"7":1},"core.admin.form":{"7":1},"core.export":{"7":1},"core.process":{"7":1}}';
