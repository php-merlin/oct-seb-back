...
<div class="seblod">
    ...
    <ul class="adminformlist adminformlist-2cols">
		...
		echo JCckDev::renderForm( 'core_dev_select', '', $config, array( 'label'=>'Task', 'selectlabel'=>'Any Task', 'options'=>'Add=add||Batch=batch||Select=select', 'required'=>'', 'storage_field'=>'task' ) );
